...
export const Item = () => {
    ...
    const foodData=[
        {
            name:"GreekSalad",
           description:" These tasty and easy green salad recipes are so versatile! They pair with just about any main dish, from pasta to pizza to salmon to chili.",
  ...
  return (
    <div className='px-5 lg:px-[100px]   '>
        ...
        <h1 className='text-2xl font-bold '>This Weeks Specials</h1>
        <button className='rounded-full btn btn-base px-7'>Menu </button>
        </div>
        <div className='flex flex-col items-center justify-center md:flex-row'>
            {
                foodData.map((item, indexItem)=>(
        <div className="card rounded-lg mt-5 overflow-clip w-[300px] glass ml-4" key={indexItem}>
       <div className=''>
  ...
  <div className="card-body bg-base">
    ...
    <div className="justify-start card-actions">
      <a href="/booking"><button className="btn btn-white">order delivery!</button></a>
    </div>
  </div>
</div>
